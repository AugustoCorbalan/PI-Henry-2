        ...
        <>
            <div className={styles.container}>
                ...
                <div className={styles.subContainer}>
                    <button onClick={()=>handlerClick('alfAsc')} className={classButton("alfAsc")}>Ascend.</button>
                    <button onClick={()=>handlerClick("alfDesc")} className={classButton("alfDesc")}>Descend.</button>
                </div>
                <h3>Salubridad</h3>
                <div className={styles.subContainer}>
                    <button onClick={()=>handlerClick("salubAsc")} className={classButton("salubAsc")}>Ascend.</button>
                    <button onClick={()=>handlerClick("salubDesc")} className={classButton("salubDesc")}>Descend.</button>
                </div>
            </div>
